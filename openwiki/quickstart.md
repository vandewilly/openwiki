...
- Also supports a **GitHub Copilot** engine that drives the official Copilot CLI for one-shot documentation runs, for users whose only model access is a Copilot subscription.
